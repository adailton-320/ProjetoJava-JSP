  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
	 ...
	 <div class="input-group mb-3">
			<input type="text" class="form-control" placeholder="Nome" id="buscarNomes" aria-label="nome" aria-describedby="basic-addon2">
			<div class="input-group-append">
			<button class="btn btn-primary" type="button" onclick="buscarNome();" >Buscar</button>
			</div>
	 </div>
	...
	function buscarNome() {
		...
		if(buscarNome != null && buscarNome!= '' && buscarNome.trim != ''){
		  ...
		  $.ajax({
			     method: "get",
			     url : acaoUrlForm,
			     data : "buscarNomes=" + buscarNome + '&acao=buscarUserAjax',
